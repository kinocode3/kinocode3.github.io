(function (ext) {
    ...
    var descriptor = {
        blocks: [
            ["R", "My position %m.pos", "getPlayerPos", 'x'],
            ["R", "My position %m.pos", "getPlayerPos", 'y'],
            ["R", "My position %m.pos", "getPlayerPos", 'z'],
            [' ', "Say %s", "postToChat", "Hello!"],
            [" ", "Chat in my position", "playerPosToChat"],
            [" ", "Set my position to x:%n y:%n z:%n", "setPlayerPos", 0, 0, 0],
            ["R", "Get ID from block x:%n y:%n z:%n %m.blockPos", "getBlock", 0, 0, 0],
            [" ", "Put block at x:%n y:%n z:%n ID %n data %n %m.blockPos", "setBlock", 0, 0, 0, 1, -1],
            [" ", "Put line of blocks from x1:%n z1:%n to x2:%n z2:%n y:%n ID %n data %n", "setLine", 0, 0, 0, 0, 0, 1, -1],
            [" ", "Put lines of blocks from x1:%n y1:%n z1:%n to x2:%n y2:%n z2:%n ID %n data %n", "setBlocks", 0, 0, 0, 0, 0, 0, 1, -1],
            [" ", "Make circle with center x1:%n z1:%n radius r:%n height y:%n to ID %n data %n", "setCircle", 0, 0, 0, 0, 0, 1, -1],
            ["h", "When a block is hit", 'whenBlockHit'],
        ],
        menus: {
            pos: ['x', 'y', 'z'],
            blockPos: ['absolute', 'rel']
        }
    };
